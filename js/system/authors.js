...
form_author.onsubmit = async (e) => {
    ...
    // Get response if 422 status code
        ...
        try {
            ...
            errorNotification("An error occurred while processing your request.", 3);
        }
    }
...
function createAuthorCard(author) {
    return `<div class="col-sm-12" style="max-width: 300px;">
...
const deleteAction = async (e) => {
    ...
    if (response.ok) {
        successNotification("Author deleted successfully.", 3);
        getAuthors(); // Reload Authors after deletion
    } else {
        errorNotification("Unable to delete author!", 3);
    }
};
...
const showAuthorData = async (id) => {
    ...
    if (response.ok) {
        ...
        errorNotification("Unable to show author!", 3);
