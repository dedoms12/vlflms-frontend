  ...
  async function renderBooks(responseData) {
    ...
    if (responseData && responseData.data && responseData.data.length > 0) {
        responseData.data.forEach(async (book) => {
            ...
            // Add Edit and Delete buttons in the dropdown
            const actionsContainer = document.createElement("div");
            actionsContainer.className = "actions";

            const dropdownContainer = document.createElement("div");
            dropdownContainer.className = "btn-group dropup float-end";
            ...
            editLink.addEventListener("click", () => editBook(book.id));
            ...
            deleteLink.addEventListener("click", () => deleteBook(book.id));
